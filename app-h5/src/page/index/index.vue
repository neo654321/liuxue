<template>
    <div ref="scroll" style="min-height: 100vh;">
        ...
        <transition name="fade">
            <div class="img_box" v-show="true" @click="toCustomerService" :style="{ bottom: isApp ? '12%' : '12%' }">
    ...
    methods: {
      ...
      getShopImage(item) {
        ...
        async requestBanner() {
            ...
            for (let i = 0; i < 3; i++) {
                this.banner.push({
                    imgUrl: require(`@/assets/image/banner/${i + 1}.png`),
