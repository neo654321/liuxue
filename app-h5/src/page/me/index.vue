...
export default {
    ...
    data() {
        return {
            ...
            images: {
                headerBg: require(`@/assets/Argos/bg.png`),
                ...
                bar: require(`@/assets/Argos/bar.png`),
            ...
            orderNav: [
                {
                    count: "0",
                    icon: require(`@/assets/Argos/icon1.png`),
                    title: this.$t("待付款"),
                    type: "0",
                    name: "waitPayCount",
                },
                {
                    count: "0",
                    icon: require(`@/assets/Argos/icon2.png`),
                    title: this.$t("待发货"),
                    type: "1",
                ...
                {
                    count: "0",
                    icon: require(`@/assets/Argos/icon3.png`),
                    title: this.$t("待收货"),
                    type: "3",
                ...
                {
                    count: "0",
                    icon: require(`@/assets/Argos/icon4.png`),
                    title: this.$t("待评价"),
                    type: "4",
                ...
                {
                    count: "0",
                    icon: require(`@/assets/Argos/icon5.png`),
                    title: this.$t("退款/售后"),
                    type: "6",
                    name: "refundCount",
                },
        ...
        merchantJump() {
            ...
            if (this.userInfo?.roletype !== 1) {
              let token = localStorage.getItem("token");
                ...
                const url = `${path}promote/#/?lang=${lang}&token=${token}&avatar=${this.userInfo?.avatar || 1}`
                if (window.plus) {
               ...
               console.log(`跳转商家后台`)
               console.log(`${path}www/#/?from=shop&token=${token}&lang=${lang}`)
